...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIII2024Summer24DRPremix/GJ-4Jets-2NLO2LO_Bin-PTG-25_Par-BiasedPTG_TuneSherpaDef_13p6TeV_sherpaMEPS/AODSIM/140X_mcRun3_2024_realistic_v26-v2/2530016/81de8cd1-6a08-4f2b-beaf-5a6307dc3ee3.root'),
...
process.NANOAODSIMoutput.SelectEvents = cms.untracked.PSet(SelectEvents = cms.vstring('SKIMEGammaHLT'))
