...
def miniAODFromMiniAOD_customizeCommon(process):
    ...
    #
    ###########################################################################
    addToProcessAndTask("slimmedKshortVertices", cms.EDProducer("PATSecondaryVertexDaughtersRekeyer",
    ...
    addToProcessAndTask("slimmedLambdaVertices", cms.EDProducer("PATSecondaryVertexDaughtersRekeyer",
    ...
    addToProcessAndTask("slimmedSecondaryVertices", cms.EDProducer("PATSecondaryVertexDaughtersRekeyer",
