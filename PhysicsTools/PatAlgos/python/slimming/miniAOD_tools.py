...
def miniAOD_customizeCommon(process):
    ...
    (_run2_miniAOD_ANY | pA_2016 | pp_on_AA | run3_repuppi_2022).toReplaceWith(task, _rerun_puppijets_task)
    ...
    def _add_metPuppi(process):
        ...
        (_run2_miniAOD_ANY | pA_2016 | pp_on_AA | run3_repuppi_2022).toReplaceWith(task, _rerun_puppimet_task)
