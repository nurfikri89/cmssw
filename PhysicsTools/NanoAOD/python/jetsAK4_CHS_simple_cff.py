...
jetTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        chHEF = Var("chargedHadronEnergyFraction()", float, doc="charged Hadron Energy Fraction", precision=12),
        neHEF = Var("neutralHadronEnergyFraction()", float, doc="neutral Hadron Energy Fraction", precision=12),
        chEmEF = Var("chargedEmEnergyFraction()", float, doc="charged Electromagnetic Energy Fraction", precision=12),
        neEmEF = Var("neutralEmEnergyFraction()", float, doc="neutral Electromagnetic Energy Fraction", precision=12),
        hfHEF = Var("HFHadronEnergyFraction()",float,doc="hadronic Energy Fraction in HF",precision=12),
        hfEmEF = Var("HFEMEnergyFraction()",float,doc="electromagnetic Energy Fraction in HF",precision=12),
        muEF = Var("muonEnergyFraction()", float, doc="muon Energy Fraction", precision=12),
        ...
        #
        ecalEnergy = Var("userFloat('ecalEnergy')", float, doc="ecalEnergy", precision=12),
        hcalEnergy = Var("userFloat('hcalEnergy')", float, doc="hcalEnergy", precision=12),
        hcalDepth1Energy = Var("userFloat('hcalDepth1Energy')", float, doc="hcalDepth1Energy", precision=12),
        hcalDepth2Energy = Var("userFloat('hcalDepth2Energy')", float, doc="hcalDepth2Energy", precision=12),
        hcalDepth3Energy = Var("userFloat('hcalDepth3Energy')", float, doc="hcalDepth3Energy", precision=12),
        hcalDepth4Energy = Var("userFloat('hcalDepth4Energy')", float, doc="hcalDepth4Energy", precision=12),
        hcalDepth5Energy = Var("userFloat('hcalDepth5Energy')", float, doc="hcalDepth5Energy", precision=12),
        hcalDepth6Energy = Var("userFloat('hcalDepth6Energy')", float, doc="hcalDepth6Energy", precision=12),
        hcalDepth7Energy = Var("userFloat('hcalDepth7Energy')", float, doc="hcalDepth7Energy", precision=12),
        hoEnergy = Var("userFloat('hoEnergy')", float, doc="hoEnergy", precision=12),
        ps1Energy = Var("userFloat('ps1Energy')", float, doc="ps1Energy", precision=12),
        ps2Energy = Var("userFloat('ps2Energy')", float, doc="ps2Energy", precision=12),
        ecalEnergyRaw = Var("userFloat('ecalEnergyRaw')", float, doc="ecalEnergyRaw", precision=12),
        hcalEnergyRaw = Var("userFloat('hcalEnergyRaw')", float, doc="hcalEnergyRaw", precision=12),
        hcalDepth1EnergyRaw = Var("userFloat('hcalDepth1EnergyRaw')", float, doc="hcalDepth1EnergyRaw", precision=12),
        hcalDepth2EnergyRaw = Var("userFloat('hcalDepth2EnergyRaw')", float, doc="hcalDepth2EnergyRaw", precision=12),
        hcalDepth3EnergyRaw = Var("userFloat('hcalDepth3EnergyRaw')", float, doc="hcalDepth3EnergyRaw", precision=12),
        hcalDepth4EnergyRaw = Var("userFloat('hcalDepth4EnergyRaw')", float, doc="hcalDepth4EnergyRaw", precision=12),
        hcalDepth5EnergyRaw = Var("userFloat('hcalDepth5EnergyRaw')", float, doc="hcalDepth5EnergyRaw", precision=12),
        hcalDepth6EnergyRaw = Var("userFloat('hcalDepth6EnergyRaw')", float, doc="hcalDepth6EnergyRaw", precision=12),
        hcalDepth7EnergyRaw = Var("userFloat('hcalDepth7EnergyRaw')", float, doc="hcalDepth7EnergyRaw", precision=12),
        hfHadEnergy = Var("userFloat('hfHadEnergy')", float, doc="hfHadEnergy", precision=12),
        hfEmEnergy = Var("userFloat('hfEmEnergy')", float, doc="hfEmEnergy", precision=12),
        hfShortEnergy = Var("userFloat('hfShortEnergy')", float, doc="hfShortEnergy", precision=12),
        hfLongEnergy = Var("userFloat('hfLongEnergy')", float, doc="hfLongEnergy", precision=12),
...
jetTable.variables.pt.precision=12
jetTable.variables.eta.precision=12
jetTable.variables.phi.precision=12
jetTable.variables.mass.precision=12
...
corrT1METJetTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(
        rawPt = Var("pt()*jecFactor('Uncorrected')",float,precision=12),
        rawMass = Var("mass()*jecFactor('Uncorrected')",float,precision=12),
        eta  = Var("eta", float,precision=12),
        phi = Var("phi", float, precision=12),
        area = Var("jetArea()", float, doc="jet catchment area, for JECs",precision=10),
        EmEF = Var("chargedEmEnergyFraction()+neutralEmEnergyFraction()", float, doc="charged+neutral Electromagnetic Energy Fraction", precision=12),
    )
)

corrT1METJetTable.variables.muonSubtrFactor = Var("1-userFloat('muonSubtrRawPt')/(pt()*jecFactor('Uncorrected'))",float,doc="1-(muon-subtracted raw pt)/(raw pt)",precision=12)
corrT1METJetTable.variables.muonSubtrDeltaEta = Var("userFloat('muonSubtrRawEta') - eta()",float,doc="muon-subtracted raw eta - eta",precision=12)
corrT1METJetTable.variables.muonSubtrDeltaPhi = Var("userFloat('muonSubtrRawPhi') - phi()",float,doc="muon-subtracted raw phi - phi",precision=12)
jetTable.variables.muonSubtrFactor = Var("1-userFloat('muonSubtrRawPt')/(pt()*jecFactor('Uncorrected'))",float,doc="1-(muon-subtracted raw pt)/(raw pt)",precision=12)
jetTable.variables.muonSubtrDeltaEta = Var("userFloat('muonSubtrRawEta') - eta()",float,doc="muon-subtracted raw eta - eta",precision=12)
jetTable.variables.muonSubtrDeltaPhi = Var("userFloat('muonSubtrRawPhi') - phi()",float,doc="muon-subtracted raw phi - phi",precision=12)
