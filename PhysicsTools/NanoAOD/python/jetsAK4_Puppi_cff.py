...
jetPuppiTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        btagDeepFlavB = Var("bDiscriminator('pfDeepFlavourJetTags:probb')+bDiscriminator('pfDeepFlavourJetTags:probbb')+bDiscriminator('pfDeepFlavourJetTags:problepb')",float,doc="DeepJet b+bb+lepb tag discriminator",precision=12),
        btagDeepFlavCvL = Var("?(bDiscriminator('pfDeepFlavourJetTags:probc')+bDiscriminator('pfDeepFlavourJetTags:probuds')+bDiscriminator('pfDeepFlavourJetTags:probg'))>0?bDiscriminator('pfDeepFlavourJetTags:probc')/(bDiscriminator('pfDeepFlavourJetTags:probc')+bDiscriminator('pfDeepFlavourJetTags:probuds')+bDiscriminator('pfDeepFlavourJetTags:probg')):-1",float,doc="DeepJet c vs uds+g discriminator",precision=12),
        btagDeepFlavCvB = Var("?(bDiscriminator('pfDeepFlavourJetTags:probc')+bDiscriminator('pfDeepFlavourJetTags:probb')+bDiscriminator('pfDeepFlavourJetTags:probbb')+bDiscriminator('pfDeepFlavourJetTags:problepb'))>0?bDiscriminator('pfDeepFlavourJetTags:probc')/(bDiscriminator('pfDeepFlavourJetTags:probc')+bDiscriminator('pfDeepFlavourJetTags:probb')+bDiscriminator('pfDeepFlavourJetTags:probbb')+bDiscriminator('pfDeepFlavourJetTags:problepb')):-1",float,doc="DeepJet c vs b+bb+lepb discriminator",precision=12),
        btagDeepFlavQG = Var("?(bDiscriminator('pfDeepFlavourJetTags:probg')+bDiscriminator('pfDeepFlavourJetTags:probuds'))>0?bDiscriminator('pfDeepFlavourJetTags:probg')/(bDiscriminator('pfDeepFlavourJetTags:probg')+bDiscriminator('pfDeepFlavourJetTags:probuds')):-1",float,doc="DeepJet g vs uds discriminator",precision=12),
        btagPNetB = Var("?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:BvsAll')>0?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:BvsAll'):-1",float,precision=12,doc="ParticleNet b vs. udscg"),
        btagPNetCvNotB = Var("?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:probb')>0?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:probc')/(1.-bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:probb')):-1",float,precision=12,doc="ParticleNet C vs notB"),
        btagPNetCvL = Var("?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:CvsL')>0?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:CvsL'):-1",float,precision=12,doc="ParticleNet c vs. udsg"),
        btagPNetCvB = Var("?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:CvsB')>0?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:CvsB'):-1",float,precision=12,doc="ParticleNet c vs. b"),
        btagPNetQvG = Var("?abs(eta())<2.5?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:QvsG'):bDiscriminator('pfParticleNetFromMiniAODAK4PuppiForwardDiscriminatorsJetTags:QvsG')",float,precision=12,doc="ParticleNet q (udsbc) vs. g"),
        btagPNetTauVJet = Var("?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:TauVsJet')>0?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralDiscriminatorsJetTags:TauVsJet'):-1",float,precision=12,doc="ParticleNet tau vs. jet"),
        PNetRegPtRawCorr = Var("?abs(eta())<2.5?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:ptcorr'):bDiscriminator('pfParticleNetFromMiniAODAK4PuppiForwardJetTags:ptcorr')",float,precision=12,doc="ParticleNet universal flavor-aware visible pT regression (no neutrinos), correction relative to raw jet pT"),
        PNetRegPtRawCorrNeutrino = Var("?abs(eta())<2.5?bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:ptnu'):bDiscriminator('pfParticleNetFromMiniAODAK4PuppiForwardJetTags:ptnu')",float,precision=12,doc="ParticleNet universal flavor-aware pT regression neutrino correction, relative to visible. To apply full regression, multiply raw jet pT by both PNetRegPtRawCorr and PNetRegPtRawCorrNeutrino."),
        PNetRegPtRawRes = Var("?abs(eta())<2.5?0.5*(bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:ptreshigh')-bDiscriminator('pfParticleNetFromMiniAODAK4PuppiCentralJetTags:ptreslow')):0.5*(bDiscriminator('pfParticleNetFromMiniAODAK4PuppiForwardJetTags:ptreshigh')-bDiscriminator('pfParticleNetFromMiniAODAK4PuppiForwardJetTags:ptreslow'))",float,precision=12,doc="ParticleNet universal flavor-aware jet pT resolution estimator, (q84 - q16)/2"),
        ...
        btagUParTAK4QvG = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:QvsG')>0?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:QvsG'):-1",float,precision=12,doc="UnifiedParT q (udsbc) vs. g"),
        ...
        #====== Custom Start
        btagUParTAK4SvBC  = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:SvsBC')>0?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:SvsBC'):-1",float,precision=12,doc="UnifiedParT s vs. bc"),
        ...
        btagUParTAK4TauVEle = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:TauVsEle')>0?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:TauVsEle'):-1",float,precision=12,doc="UnifiedParT tau vs. electron"),
        btagUParTAK4TauVMu = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:TauVsMu')>0?bDiscriminator('pfUnifiedParticleTransformerAK4DiscriminatorsJetTags:TauVsMu'):-1",float,precision=12,doc="UnifiedParT tau vs. muon"),
        ...
        btagUParTAK4problepb =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:problepb')",float,precision=12,doc="UnifiedParT lepb raw score"),
        btagUParTAK4probc =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probc')",float,precision=12,doc="UnifiedParT c raw score"),
        btagUParTAK4probs =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probs')",float,precision=12,doc="UnifiedParT s raw score"),
        btagUParTAK4probu =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probu')",float,precision=12,doc="UnifiedParT u raw score"),
        btagUParTAK4probd =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probd')",float,precision=12,doc="UnifiedParT d raw score"),
        btagUParTAK4probg =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probg')",float,precision=12,doc="UnifiedParT g raw score"),
        btagUParTAK4probele =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probele')",float,precision=12,doc="UnifiedParT ele raw score"),
        btagUParTAK4probmu =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probmu')",float,precision=12,doc="UnifiedParT muon raw score"),
        btagUParTAK4probtaup1h0p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaup1h0p')",float,precision=12,doc="UnifiedParT taup1h0p raw score"),
        btagUParTAK4probtaup1h1p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaup1h1p')",float,precision=12,doc="UnifiedParT taup1h1p raw score"),
        btagUParTAK4probtaup1h2p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaup1h2p')",float,precision=12,doc="UnifiedParT taup1h2p raw score"),
        btagUParTAK4probtaup3h0p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaup3h0p')",float,precision=12,doc="UnifiedParT taup3h0p raw score"),
        btagUParTAK4probtaup3h1p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaup3h1p')",float,precision=12,doc="UnifiedParT taup3h1p raw score"),
        btagUParTAK4probtaum1h0p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaum1h0p')",float,precision=12,doc="UnifiedParT taum1h0p raw score"),
        btagUParTAK4probtaum1h1p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaum1h1p')",float,precision=12,doc="UnifiedParT taum1h1p raw score"),
        btagUParTAK4probtaum1h2p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaum1h2p')",float,precision=12,doc="UnifiedParT taum1h2p raw score"),
        btagUParTAK4probtaum3h0p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaum3h0p')",float,precision=12,doc="UnifiedParT taum3h0p raw score"),
        btagUParTAK4probtaum3h1p =  Var("bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:probtaum3h1p')",float,precision=12,doc="UnifiedParT taum3h1p raw score"),
        #====== Custom End
        UParTAK4RegPtRawCorr = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptcorr')>0?bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptcorr'):-1",float,precision=12,doc="UnifiedParT universal flavor-aware visible pT regression (no neutrinos), correction relative to raw jet pT"),
        UParTAK4RegPtRawCorrNeutrino = Var("?bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptnu')>0?bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptnu'):-1",float,precision=12,doc="UnifiedParT universal flavor-aware pT regression neutrino correction, relative to visible. To apply full regression, multiply raw jet pT by both UParTAK4RegPtRawCorr and UParTAK4RegPtRawCorrNeutrino."),
        UParTAK4RegPtRawRes = Var("?(bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptreshigh')+bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptreslow'))>0?0.5*(bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptreshigh')-bDiscriminator('pfUnifiedParticleTransformerAK4JetTags:ptreslow')):-1",float,precision=12,doc="UnifiedParT universal flavor-aware jet pT resolution estimator, (q84 - q16)/2"),
