...
process.SKIM_HLTDiMuon = cms.Path(process.skimHLTDiMuonSequence)
#
process.nanoAOD_step.insert(0, process.skimHLTDiMuonSequence)
process.NANOAODoutput.SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring('SKIM_HLTDiMuon')
)
process.schedule.insert(0, process.SKIM_HLTDiMuon)
